      ...
      >
        ...
        <div className="absolute inset-5">
          <div className="grid grid-cols-2">
            <div className="bg-gray-950/85 me-36 pt-5 ps-5 pb-5 rounded-lg">
              ...
              <a href="#download" type="button" className="p-4 bg-everglade-800 text-everglade-50 hover:bg-everglade-900 rounded-lg font-bold me-4 cursor-pointer transition duration-300">
                Descargar
              </a>

              <a href="#features" className="p-4 bg-tangaroa-800 hover:bg-tangaroa-900 text-tangaroa-50 rounded-lg font-bold cursor-pointer cursor-pointer transition duration-300">
                Novedades
              </a>
